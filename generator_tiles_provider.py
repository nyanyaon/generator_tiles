...
from .generator_tiles_algorithm import GeneratorTilesAlgorithm


class GeneratorTilesProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(GeneratorTilesAlgorithm())
